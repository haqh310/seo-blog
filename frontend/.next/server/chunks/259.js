...
/* harmony import */ var _actions_blog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(448);
...
/* harmony import */ var _actions_auth__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(9110);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_actions_blog__WEBPACK_IMPORTED_MODULE_6__, _actions_category__WEBPACK_IMPORTED_MODULE_7__, _actions_tag__WEBPACK_IMPORTED_MODULE_8__, _actions_auth__WEBPACK_IMPORTED_MODULE_10__]);
([_actions_blog__WEBPACK_IMPORTED_MODULE_6__, _actions_category__WEBPACK_IMPORTED_MODULE_7__, _actions_tag__WEBPACK_IMPORTED_MODULE_8__, _actions_auth__WEBPACK_IMPORTED_MODULE_10__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);




const ReactQuill = next_dynamic__WEBPACK_IMPORTED_MODULE_3___default()(()=>Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 2586, 23)), {
    loadableGenerated: {
        modules: [
...
const BlogUpdate = ({ router  })=>{
    ...
    const [imageName, setImageName] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    ...
    const token = (0,_actions_auth__WEBPACK_IMPORTED_MODULE_10__/* .getCookie */ .ej)("token");
    ...
    const initBlog = ()=>{
        ...
        if (slug) {
            (0,_actions_blog__WEBPACK_IMPORTED_MODULE_6__/* .singleBlog */ .Ch)(slug).then((data)=>{
                if (data.error) {
                    console.log(data.error);
                } else {
                    setValues({
    ...
    const editBlog = (e)=>{
        e.preventDefault();
        (0,_actions_blog__WEBPACK_IMPORTED_MODULE_6__/* .updateBlog */ .zZ)(formData, token, router.query.slug).then((data)=>{
            if (data.error) {
                setValues({
                    ...values,
                    error: data.error
                ...
                const auth = (0,_actions_auth__WEBPACK_IMPORTED_MODULE_10__/* .isAuth */ .$D)();
                if (auth && auth.role === 1) {
                    next_router__WEBPACK_IMPORTED_MODULE_1___default().replace(`/admin`);
                } else if (auth && auth.role === 0) {
                    next_router__WEBPACK_IMPORTED_MODULE_1___default().replace(`/user`);
                }
            }
        });
    };
            ...
            children: [
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        ...
                        body && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                            src: `${_config__WEBPACK_IMPORTED_MODULE_9__/* .API */ .bl}/blog/photo/${router.query.slug}`,
                            alt: title,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_router__WEBPACK_IMPORTED_MODULE_1__.withRouter)(BlogUpdate));
